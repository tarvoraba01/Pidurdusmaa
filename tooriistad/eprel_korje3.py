# -*- coding: utf-8 -*-
"""Pidurdusmaa.ee — EPREL-i rehvikorje, 3. ring (rohkem mõõte).

MIDA TA TEEB
------------
Täiendab faili eprel2.json (samas kaustas) nende rehvimõõtudega, mis
seal veel puuduvad: kõigi lehe ~430 auto tehasemõõdud + levinud
alternatiivmõõdud, kokku 96 mõõtu. Varem korjatud 10 mõõtu jäävad alles.

EPREL ei lehitse (iga päring annab kuni 25 rida), seega küsitakse
MÕÕT + MARK paaride kaupa. See on ~8000 päringut; skript teeb kolm
korraga ja võtab u 30–60 minutit.
...
-----------------------
    cd ~/Downloads
    python3 eprel_korje3.py eprel-key.txt
"""
...
MOODUD = [
    "215/55 R17", "235/65 R17", "215/60 R17", "195/55 R16", "215/55 R16", "215/65 R17",
    "225/60 R17", "175/65 R14", "215/70 R16", "225/50 R17", "235/55 R17", "255/55 R18",
    "205/65 R15", "265/65 R17", "165/70 R14", "175/65 R15", "215/55 R18", "225/45 R17",
    "225/55 R18", "235/55 R19", "235/65 R16", "255/65 R17", "165/65 R14", "175/70 R13",
    "185/60 R14", "195/60 R15", "195/60 R16", "205/60 R17", "205/65 R16", "215/70 R15",
    "225/55 R16", "225/60 R18", "235/45 R18", "235/55 R18", "245/45 R18", "245/45 R19",
    "255/60 R18", "145/65 R15", "155/65 R14", "155/70 R14", "155/70 R19", "165/60 R14",
    "165/70 R13", "175/60 R15", "175/60 R16", "185/55 R16", "185/65 R14", "185/75 R14",
    "185/75 R16", "195/50 R16", "195/55 R15", "195/80 R15", "205/60 R15", "215/50 R17",
    "215/50 R18", "215/60 R15", "215/75 R16", "225/45 R18", "225/50 R18", "225/60 R15",
    "225/65 R16", "235/65 R18", "235/70 R16", "245/45 R20", "245/70 R16", "255/45 R19",
    "255/50 R19", "255/55 R19", "255/60 R19", "255/70 R15", "255/70 R16", "255/75 R17",
    "265/50 R19", "265/60 R18", "175/70 R14", "185/55 R15", "185/60 R16", "185/70 R14",
    "195/45 R16", "195/50 R15", "195/70 R15", "205/40 R17", "205/45 R17", "205/50 R17",
    "215/40 R17", "215/45 R17", "225/35 R19", "225/40 R18", "225/70 R15", "235/40 R19",
    "235/50 R19", "245/35 R19", "245/40 R18", "245/65 R17", "255/40 R19", "275/40 R20",
]
